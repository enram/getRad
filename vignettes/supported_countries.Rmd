...
included_countries <- dplyr::tribble(
  ...
  sf::st_as_sf() |>
  dplyr::rowwise() |>
  dplyr::mutate(supported = factor(supported), links_html = dplyr::if_else(length(links) == 0, "", paste("<p><strong>Links: </strong><ul>", paste0("<li><a href='", links, "'>", names(links), "</a></li>", collapse = ""), "</ul></p>")))
